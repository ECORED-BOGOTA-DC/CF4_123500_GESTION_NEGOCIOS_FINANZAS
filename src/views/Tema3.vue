...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-lg-10
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")(data-aos="fade-up")
          ...
          div(titulo=" Variación tarifa de impuesto de renta personas jurídicas")
            .row.align-items-star.justify-content-center.p-4
              .col-lg-6
                img.align(src='@/assets/curso/images/tema3/fig_4.svg',  alt='', style="width:420px; display:block; margin:auto 0 ;")
    ...
    #t_3_3.titulo-segundo
      .h2 3.3 Tasas y contribucioness
    ...
    TabsC.color-acento-contenido.mb-5(data-aos="zoom-in-down")
      .py-4.py-md-4.mg-top-2(titulo="Las contribuciones")
      ...
      .py-3.py-md-4.mg-top-2(titulo="Tasas")
        .row.justify-content-center.align-items-center.p-4
          .col-12.col-md-7.mb-3.mb-md-0
